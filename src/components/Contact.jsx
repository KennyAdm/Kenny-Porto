...
import { Send, Phone, MapPin, Mail, Instagram } from 'lucide-react';
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append('access_key', '7cb5c758-0657-430a-a4fa-17b327f2de72'); // Replace with your Web3Forms access key
              ...
              <div className='space-y-6'>
                ...
                <div className='flex items-center space-x-4'>
                  <div className='bg-rose-500/10 p-3 rounded-lg'>
                   <a href="https://www.instagram.com/kennyadm_/" target="_blank" rel="noopener noreferrer"> <Instagram className='w-6 h-6 text-rose-400' /></a>
                  </div>
                  <div>
                    <h3 className='font-semibold'>Instagram</h3>
                    <p className='text-gray-400'>
                      <a href="https://www.instagram.com/kennyadm_/" className="hover:text-rose-400 transition-colors">@kennyadm_</a>
                    </p>
                  </div>
                </div>
              </div>
